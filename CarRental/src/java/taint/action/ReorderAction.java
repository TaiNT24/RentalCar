...
public class ReorderAction {
    ...
    public String execute() throws Exception {
        ...
        if (cart != null) {
            ...
            if(listRentCar.isEmpty()){
                cartDAO.deleteCart(cart.getIdCart());
            }else{
                dtrcDAO.deleteAllDateRentCarOfCart(listRentCar);
                
                rentCarDAO.deleteAllRentCarFromCart(listRentCar);
        ...
        totalCart = cartDAO.getTotalPriceCart(CartID);
        listRentCar
                = rentCarDAO.getListRentCarOfUser(CartID);

        rentCarDAO.setStatusCarRent(listRentCar, "Insert");
        cartDAO.setCurrentCart(CartID);
